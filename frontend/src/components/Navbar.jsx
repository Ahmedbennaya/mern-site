          ...
          <div className="flex items-center justify-center md:justify-end space-x-4">
            ...
            <div className="relative">
              <button
                ...
                className="text-white hover:underline flex items-center transition-all duration-200"
        ...
        <div className="container mx-auto px-4 lg:px-8 py-4 flex justify-between items-center">
          ...
          <div className="lg:flex hidden items-center space-x-4">
            {userInfo ? (
              ...
              <div className="flex items-center space-x-3">
                <Link
                  className="inline-flex items-center justify-center rounded-xl bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 transition-all duration-150 hover:bg-gray-50 hover:ring-gray-400"
                  to="/signin"
                >
                  Login
                </Link>
