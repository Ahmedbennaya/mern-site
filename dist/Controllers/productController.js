...
export const getBlindsShades = async (req, res) => {
  try {
    ...
    res.status(500).json({
      message: 'Error fetching Blinds & Shades products'
    });
  }
};
...
export const getCurtainsDrapes = async (req, res) => {
  try {
    ...
    res.status(500).json({
      message: 'Error fetching Curtains & Drapes products'
    });
  }
};
...
export const getFurnishings = async (req, res) => {
  try {
    ...
    res.status(500).json({
      message: 'Error fetching Furnishings products'
    });
  }
};
...
export const getSmartHome = async (req, res) => {
  try {
    ...
    res.status(500).json({
      message: 'Error fetching Smart Home products'
    });
  }
};
...
export const addBlindsShadesProduct = async (req, res) => {
  try {
    ...
    res.status(500).json({
      message: 'Error adding Blinds & Shades product'
    });
  }
};
...
export const addCurtainsDrapesProduct = async (req, res) => {
  try {
    ...
    res.status(500).json({
      message: 'Error adding Curtains & Drapes product'
    });
  }
};
...
export const addFurnishingsProduct = async (req, res) => {
  try {
    ...
    res.status(500).json({
      message: 'Error adding Furnishings product'
    });
  }
};
...
export const addSmartHomeProduct = async (req, res) => {
  try {
    ...
    res.status(500).json({
      message: 'Error adding Smart Home product'
    });
  }
};